	...
	<div id="main-container-secondline" <?php secondline_themes_page_title(); ?>>
		...
		<?php if (get_theme_mod( 'secondline_themes_header_fixed', 'fixed-slt' ) == 'fixed-slt' && get_theme_mod( 'secondline_themes_logo_position', 'secondline-themes-logo-position-left' ) != 'secondline-themes-logo-position-center'  ) : ?><div id="secondline-fixed-nav"><?php endif; ?>
			<header id="masthead-slt" class="secondline-themes-site-header <?php echo esc_attr( get_theme_mod('secondline_themes_nav_align', 'secondline-themes-nav-right') ); ?>">
				<?php if (get_theme_mod( 'secondline_themes_header_fixed', 'fixed-slt' ) == 'fixed-slt') : ?><div id="secondline-themes-sidebar-fixed-nav"><?php endif; ?>
				...
				<?php if (get_theme_mod( 'secondline_themes_header_fixed', 'fixed-slt' ) == 'fixed-slt' ) : ?></div><!-- close #secondline-themes-sidebar-fixed-nav --><?php endif; ?>
			</header>
		<?php if (get_theme_mod( 'secondline_themes_header_fixed', 'fixed-slt' ) == 'fixed-slt' && get_theme_mod( 'secondline_themes_logo_position', 'secondline-themes-logo-position-left' ) != 'secondline-themes-logo-position-center') : ?></div><!-- close #secondline-fixed-nav --><?php endif; ?>

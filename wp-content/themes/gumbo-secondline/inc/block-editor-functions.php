...
function secondline_gutenberg_colors() {
	...
	$accent = get_theme_mod( 'secondline_themes_button_background', '#e65a4b' );
	$accent_hover = get_theme_mod( 'secondline_themes_button_background_hover', '#1b1b1b' );
	// Build styles.
	$css  = '';
	...
	$css .= '.has-black-light-background-color { background-color: #1b1b1b !important; }';
	$css .= '.has-black-light-color { color: #1b1b1b !important; }';
...
function secondline_gutenberg_editor_colors() {
	...
	$link_color = get_theme_mod( 'secondline_themes_default_link_color', '#e65a4b' );
	$link_hover_color = get_theme_mod( 'secondline_themes_default_link_hover_color', '#1b1b1b' );
	...
	$css .= '.editor-styles-wrapper {background-color: ' . get_theme_mod( 'secondline_themes_background_color', '#ffffff' ) . ' !important;}';	

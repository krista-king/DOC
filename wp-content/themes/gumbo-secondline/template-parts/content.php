...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="secondline-themes-default-blog-index <?php echo esc_attr( get_theme_mod('secondline_themes_blog_transition') ); ?>">
		...
		<div class="secondline-blog-content">
			...
			<?php if ( 'post' == get_post_type() || 'podcast' == get_post_type() || 'episode' == get_post_type()) : ?>
				<div class="secondline-post-meta">
                    ...
                    <?php if (get_theme_mod( 'secondline_themes_blog_meta_date_display', 'true') == 'true') : ?><span class="blog-meta-date-display"><a href="<?php the_permalink(); ?>"><?php the_time(get_option('date_format')); ?></a></span><?php endif; ?>
                    ...
                    <?php if (get_theme_mod( 'secondline_themes_blog_meta_comment_display', 'true') == 'true') : ?><span class="blog-meta-comments"><?php comments_popup_link( '' . wp_kses( __( '0 Comments', 'gumbo-secondline' ), true ) . '', wp_kses( __( '1 Comment', 'gumbo-secondline' ), true), wp_kses( __( '% Comments', 'gumbo-secondline' ), true ) ); ?></span><?php endif; ?>
			...
			<div class="secondline-themes-blog-excerpt">
				<?php
					if ( is_singular() ) {
						...
						the_excerpt();
						echo '<a href="'. get_the_permalink() .'" class="more-link">' . esc_attr__('Read More', 'gumbo-secondline') . '</a>';
					};
				?>
		...
		<?php if ( is_sticky() && is_home() && ! is_paged() ) { printf( '<div class="secondline-themes-sticky-post">%s</div>', esc_html__( 'FEATURED', 'gumbo-secondline' ) ); } ?>
